...
namespace Ftareqi.Persistence.Migrations
{
    ...
    [Migration("20260620184800_AddedBanTable")]
    partial class AddedBanTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ftareqi.Domain.Models.Ban", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ftareqi.Domain.Models.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ftareqi.Domain.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ftareqi.Domain.Models.RidePreferences", b =>
                {
                    ...
                    b.Property<bool>("OpenToConversation")
                        .HasColumnType("bit");

                    b.Property<bool>("PetsWelcomed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Ftareqi.Domain.Models.Ban", b =>
                {
                    b.HasOne("Ftareqi.Domain.Models.User", "BannedByUser")
                        .WithMany("BansIssued")
            ...
            modelBuilder.Entity("Ftareqi.Domain.Models.Report", b =>
                {
                    b.HasOne("Ftareqi.Domain.Models.User", "ReportedUser")
                        .WithMany("ReportsReceived")
                        .HasForeignKey("ReportedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Ftareqi.Domain.Models.User", "ReporterUser")
            ...
            modelBuilder.Entity("Ftareqi.Domain.Models.Review", b =>
                {
                    ...
                    b.HasOne("Ftareqi.Domain.Models.RideBooking", "RideBooking")
                        .WithOne("Review")
                        .HasForeignKey("Ftareqi.Domain.Models.Review", "RideBookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ftareqi.Domain.Models.RideBooking", b =>
                {
                    b.HasOne("Ftareqi.Domain.Models.Ride", "Ride")
            ...
            modelBuilder.Entity("Ftareqi.Domain.Models.RidePreferences", b =>
                {
                    b.HasOne("Ftareqi.Domain.Models.Ride", "Ride")
                        .WithOne("RidePreferences")
                        .HasForeignKey("Ftareqi.Domain.Models.RidePreferences", "RideId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
